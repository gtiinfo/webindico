...
<head>
  ...
  <title>Consultar Estado de Sinistro | ÍNDICO SEGUROS</title>
      ...
      <div class="box-center">
        <div class="box-medium" style="max-width: 400px;">
          <div class="title-bar">
            ...
            <h4 class="title">Consultar Estado do Sinistro</h4>
          </div>
          <div class="content">
          <form class="needs-validation" novalidate action="https://api.whatsapp.com/send?phone=+2588502727270&text=&source=&data=">
              <div class="mb-3">
                <label for="validationCustom01" class="form-label">Número do Processo</label>
                <input type="number" class="form-control numProcesso" name="numProcesso" value="" required>
              </div>
              <div class="mb-3">
                <input type="submit" class="btn btn-primary btn-indico consultar" value="Consultar">
              </div>
            </form>
          </div>
        ...
        <div class="center-content">
          <div class="col-menu">
            <ul class="menu">
              ...
              <li><a href="../particulares/danos-proprios.php">Danos Próprios</a></li>
              <li><a href="../particulares/responsabilidade-civil.php">Responsabilidade Civil</a></li>
              <li><a href="../particulares/responsabilidade-civil-bombas.php">Responsabilidade Civil Bombas</a></li>
              <li><a href="../particulares/habitacao.php">Multirisco Habitação</a></li>
              <li><a href="../particulares/empregado-domesticos.php">Empregados Domésticos</a></li>
              <li><a href="../particulares/funeral.php">Funeral</a></li>
              <li><a href="../particulares/acidente-pessoas.php">Acidentes Pessoais</a></li>
              <li><a href="../particulares/viagem.php">Viagem</a></li>
