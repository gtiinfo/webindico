...
<head>
  ...
  <title>Participar de Sinistro| ÍNDICO SEGUROS</title>
...
<div class="modal top fade" style="z-index: 1111111" id="cookieconsent3" tabindex="-1" aria-labelledby="cookieconsentLabel3"
      ...
      <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner slider">
          ...
          <div class="carousel-item slider" style="background-image: url(../assets/img/slides/engenharias_banner.png);">
            ...
            <div class="content d-flex justify-content-start align-items-center h-100 p-5" style="z-index: 99999; max-width: 450px;">
              <div class="text-white text-center text-md-start">
                <h1 class="mb-5 title">Ngião deixe que o imprevisto lhe paralize</h1>
              </div>
            </div>
          </div>
      ...
      <div class="box-center">
        <div class="box-medium" style="max-width: 400px;">
          <div class="title-bar">
            ...
            <h4 class="title">Participar de Sinistro</h4>
          </div>
          <div class="content">
            <div class="mb-4">
              <select id="tipoSeguroParticular" class="form-control">
                <option selected>Tipo de Seguro</option>
                <option value="automovel">Automóvel</option>
                <option value="acidenteTrabalho">Acidente de Trabalho</option>
                <option value="multirisco">Multirisco Habitação</option>
                <option value="engenharia">Engenharia</option>
                <option value="ransporteMercadorias">Transporte de Mercadorias</option>
                <option value="saude">Saúde</option>

              </select>
            </div>
            <div class="mb-3">
              <button id="btnParticipar" class="btn btn-primary btn-indico">Participar</button>
            </div>
          </div>
  ...
  <div class="card-form" style="height: 500px;">
    <div class="close"></div>
    <div class="title">
    ...
    <div class="list-inpts">
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
          <a class="caminho" href="javacrip:void(0)" target="_blank">Baixar e preencher formulário Editável</a>
        </div>
        <input type="text" name="teste" class="teste d-none">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="">Número da Apólices</label>
          <input type="text" class="form-control" name="numApolice" required>
        </div>
        <div class="mb-3">
          <label for="">Upload do Formulário</label>
          <input type="file" class="form-control" name="formularioAuto" required>
        </div>
        <div class="mb-3">
