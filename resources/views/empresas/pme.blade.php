      ...
      <div class="">
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            ...
            <div class="content">
              <p class="content-text">Preocupada com as suas necessidades, o seguro PME´s visa a oferta de serviços e
                produtos altamente competitivos e de vantagens acrescidas. Aliado ao alto nível de atendimento está a
                garantia de maior conforto, através de plataformas inovadoras e diferenciadas, preços e coberturas a
                nível das suas exigências com o simples objectivo de potenciar o sucesso da sua empresa. De forma
                personalizada, avaliamos o nível de protecção necessário para cada uma das áreas vitais da sua empresa,
                e do seu negócio.</p>
