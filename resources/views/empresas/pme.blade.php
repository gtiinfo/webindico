...
<head>
    ...
    <title>PME's | ÍNDICO SEGUROS</title>
                ...
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        <div class="title-bar">
                            ...
                            <h4 class="title">PME´s</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">Preocupada com as suas necessidades, o seguro PME´s visa a oferta
                                de serviços e
                                produtos altamente competitivos e de vantagens acrescidas. Aliado ao alto nível de
                                atendimento está a
                                garantia de maior conforto, através de plataformas inovadoras e diferenciadas, preços e
                                coberturas a
                                nível das suas exigências com o simples objectivo de potenciar o sucesso da sua empresa.
                                De forma
                                personalizada, avaliamos o nível de protecção necessário para cada uma das áreas vitais
                                da sua empresa,
                                e do seu negócio.</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/pme_larg.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">PME´s</p>
                                ...
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="PME´s">
