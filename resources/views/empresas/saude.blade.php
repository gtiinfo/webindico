            ...
            <div class="">
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        ...
                        <div class="content">
                            <p class="content-text">O seguro de saúde, garante ao segurado uma cobertura para
                                tratamentos médicos,
                                assim como aos custos de serviços e materiais relacionados à restituição da saúde do
                                segurado.</p>
                            ...
                            <ul class="row" style="list-style: none;">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <li><span><i class='bx bx-check me-2'></i></i>Despesas com Próteses
                                            Ortóteses</span></li>
                                    <li><span><i class='bx bx-check me-2'></i></i>Medicina Preventiva (Check-up)</span>
                                    </li>
                                    <li><span><i class='bx bx-check me-2'></i></i>Emergência Médica e Evacuação</span>
                                    </li>
                                    ...
                                    <div class="gallery-content">
                                        <div class="gallery-card">
                                            <div>
                                                ...
                                                <span>Garantia de que o requerente não sofre de doença terminal no
                                        ...
                                        <div class="gallery-card border-end-0">
                                            <div>
                                                ...
                                                <span>Garantia que no início da cobertura, o requerente não sofre ou foi
                                                    tratado</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-bottom-0">
                                            <div>
                                                ...
                                                <span>Garantia que o requerente nunca foi aconselhado a seguir, no
                                                    futuro, um tratamento
                                        ...
                                        <div class="gallery-card border-end-0 border-bottom-0">
                                            <div>
                                                ...
                                                <span>Garantia que, caso a pessoa coberta pela apólice tenha feito
                                                    qualquer reclamação ao
                                                    abrigo da apólice anterior e o montante segurado seja aumentado pela
                                                    apólice atual, para uma
                                                    reclamação adicional para a mesma doença durante a apólice actual, o
                                                    limite anterior de soma
                                                    segurada será aplicável e não a importância segurada
                                                    reforçada</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-cotacao">
                                ...
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Saúde">
