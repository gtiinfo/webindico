...
<head>
  ...
  <title>Pagamento Prémio | ÍNDICO SEGUROS</title>
        ...
        <div class="box-center">
          <div class="box-medium" style="max-width: 400px;">
            <div class="title-bar">
              ...
              <h4 class="title">Aviso de Cobrança</h4>
            </div>
            <div class="content">
              <form action="" class="needs-validation" novalidate>
                <div class="form-contact m-2">
                  ...
                  <div class="mb-4 has-validation">
                    ...
                    <select class="form-control" type="text" id="" required>
                      <option disabled selected value=""> -- Seleccione uma opção -- </option>
                      <option>Mpesa</option>
                      <option>Emola</option>
                      <option>Webcollet</option>
                    </select>
                    <small class="invalid-feedback">
                      Por favor o campo é obrigatorio!
                    </small>
                  ...
                  <div class="mb-4">
                    <button class="btn btn-primary btn-indico">Visualizar</button>
                  </div>
                </div>
              </form> 
            </div>
