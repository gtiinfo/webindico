...
<head>
  ...
  <title>Condições Gerais | ÍNDICO SEGUROS</title>
  ...
  <section class="box">
    <div class="">
      <div class="box-center">
        <div class="box-medium" style="max-width: 550px;">
          <div class="title-bar">
            <div class="title-icon"></div>
            <h4 class="title">Condições Gerais</h4>
          </div>
          <div class="content">
            <ul class="list-docs">
              <li><a href="../assets/documents/Seguro_Automovel_v01.pdf">Automóvel</a></li>
              <li><a href="../assets/documents/WCA.pdf">Acidentes de Trabalho e Doenças Profissionais</a></li>
              <li><a href="../assets/documents/Seguro_Acidentes_Pessoais_Grupo.pdf">Acidentes Pessoais</a></li>
              <li><a href="../assets/documents/SEGURO_ANIMAIS_DOMESTICOS.pdf">Animais Domesticos</a></li>
              <li><a href="../assets/documents/Seguro_Credito_Empresas.pdf">Crédito</a></li>
              <li><a href="../assets/documents/SEGURO_DE_EQUIPAMENTO_ELECTRONICO_V01.pdf">Equipamento Portátil e
                  Telefones</a></li>
              <li><a href="../assets/documents/SEGURO_DE_FIDELITY GUARANTEE.pdf">Fidelidade</a></li>
              <li><a href="../assets/documents/CG_MARITIMO_CASCOS.pdf">Marítimo</a></li>
              <li><a href="../assets/documents/Seguro_Mercadoria_Transito.pdf">Mercadoria em Trânsito</a></li>
              <li><a href="../assets/documents/SEGURO_SAUDE.pdf">Saúde</a></li>
              <li><a href="../assets/documents/Seguro_Incendio.pdf">Incêndio</a></li>
              <li><a href="../assets/documents/SEGURO_DE_QUEBRA_DE_VIDROS_v01.pdf">Quebra de Vidros</a></li>
              <li><a href="../assets/documents/SEGURO_DE_LUCROS_CESSANTES_v01.pdf">Lucros Cessantes</a></li>
              <li><a href="../assets/documents/SEGURO_DE_NUMERRIO_v01.pdf">Numerário</a></li>
              <li><a href="../assets/documents/Seguro_Empreitada.pdf">Engenharia</a></li>
              <li><a href="../assets/documents/SEGURO_DE_ROUBO_v01.pdf">Roubo</a></li>
              <li><a href="../assets/documents/SEGURO_DE_RESPONSABILIDADE_CIVIL_GERAL_V01.pdf">Responsabilidade Civil
                  Geral</a></li>
              <li><a href="../assets/documents/Seguro_Viagem.pdf">Viagem</a></li>
            </ul>
