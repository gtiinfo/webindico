                                        ...
                                        <div class="component-content">
                                            <div class="tabs-inner">
                                                <ul class="tabs-heading">
                                                    ...
                                                    <li><a href="{{ __(route('view.empresas')) }}"
                                                            class="active">Empresas</a></li>
                                                ...
                                                <div class="tabs-container">
                                                    <ul class="tabs-body">
                                                        <div class="item-0">
                                                            ...
                                                            <div class="list-item">
                                                                <ul>
                                                                    ...
                                                                    <ul class="dropdown1">
                                                                        <li><a
                                                                                href="{{ __(route('view.resp-civil-auto')) }}">Responsabilidade
                                                                                Civil</a></li>
                                                                        <li><a
                                                                                href="{{ __(route('view.danos-proprios-emp')) }}">Danos
                                                                                Próprios</a></li>
                                                                    </ul>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.acidente-trabalho')) }}">Acidentes
                                                                            de Trabalho</a></li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.saude')) }}">Saúde</a>
                                                                    </li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.saude')) }}">Engenharias</a>
                                                                    </li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.incendio')) }}">Incêndio</a>
                                                                    </li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.respCivil-emp')) }}">Responsabilidade
                                                                            Civil</a></li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a href="{{ __(route('view.pme')) }}">PMEs</a>
                                                                    </li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a href="{{ __(route('view.negocio')) }}">Multiriscos
                                                                            Negócio</a></li>
                                                                </ul>
                                                        ...
                                                        <div class="item-0">
                                                            ...
                                                            <div class="list-item">
                                                                <ul>
                                                                    <li><a href="{{ __(route('view.sinistro-emp')) }}">Participar
                                                                            de Sinistro</a></li>

                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.cons-sinistro-emp')) }}">Consultar
                                                                            Sinistro</a></li>
                                                                </ul>
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.oficinas-emp')) }}">Oficinas</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="item-0">
                                                            ...
                                                            <div class="list-item">
                                                                <ul>
                                                                    <li><a
                                                                            href="{{ __(route('view.condicoes-gerais-emp')) }}">Condições
                                                                            Gerais</a></li>
                                                                </ul>
                                                                ...
                                                                <ul dropdown1>
                                                                    <li><a
                                                                            href="{{ __(route('view.aviso-cobranca-emp')) }}">Aviso
                                                                            de Cobrança</a></li>
                                                                    <li><a
                                                                            href="{{ __(route('view.pag-premio-emp')) }}">Pagamento
                                                                            Prémio</a></li>
                                                                    <li><a
                                                                            href="{{ __(route('view.reembolso-emp')) }}">Reembolso</a>
                                                                    </li>
                                                                    <li><a
                                                                            href="{{ __(route('view.recibo-emp')) }}">Recibo</a>
                                                                    </li>
                                                                </ul>
                                                                <ul>
                                                                    ...
                                                                    <ul class="dropdown1">
                                                                        <li><a
                                                                                href="{{ __(route('view.reclamacoes')) }}">Reclamações</a>
                                                                        </li>
                                                                    </ul>
                                                                </ul>
                                                                <ul>
                                                                    ...
                                                                    <ul class="dropdown1">
                                                                        <li><a
                                                                                href="{{ __(route('view.actualizacao-capital-emp')) }}">Actualização
                                                                                de Capital</a></li>
                                                                        <li><a
                                                                                href="{{ __(route('view.actualizacao-dados-emp')) }}">Actualização
                                                                                de Dados</a></li>
                                                                    </ul>
                                                                </ul>
                                                            </div>
                                    ...
                                    <li>
                                        <div class="container1 item-area">
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.resp-civil-auto')) }}"
                                                        class="menu-dropdown" id="menu-dropdown">Responsabilidade
                                                        Civil</a></li>
                                                <li><a href="{{ __(route('view.danos-proprios-emp')) }}"
                                                        class="menu-dropdown" id="menu-dropdown">Danos Próprios</a>
                                                </li>
                                            </ul>
                                            <ul>
                                                <li class="title">Acidentes de Trabalho</li>
                                                <li><a href="{{ __(route('view.acidente-trabalho')) }}">Acidentes de
                                                        Trabalho</a></li>
                                            </ul>
                                            <ul>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.respCivil-emp')) }}">Responsabilidade
                                                        Civil Geral</a></li>
                                            </ul>
                                            <ul>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.negocio')) }}">Multiriscos Negócio</a>
                                                </li>
                                            </ul>
                                    ...
                                    <li>
                                        <div class="container1 item-area">
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.sinistro-emp')) }}">Participar do
                                                        Sinistro</a>
                                                </li>
                                            </ul>
                                            <ul>
                                                <li class="title">Consultar</li>
                                                <li><a href="{{ __(route('view.cons-sinistro-emp')) }}">Consultar
                                    ...
                                    <li>
                                        <div class="container1 item-area">
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.condicoes-gerais-emp')) }}">Condições
                                                        Gerais</a></li>
                                            </ul>
                                            <ul>
                                                <li class="title">Gestão de Valores</li>
                                                <li><a href="{{ __(route('view.aviso-cobranca-emp')) }}">Aviso de
                                                        Cobrança</a></li>
                                                <li><a href="{{ __(route('view.pag-premio-emp')) }}">Pagamento
                                                        Prémio</a></li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ __(route('view.actualizacao-capital-emp')) }}">Actualização
                                                        de Capital</a></li>
                                                <li><a href="{{ __(route('view.actualizacao-dados-emp')) }}">Actualização
                                                        de Dados</a></li>
                                            </ul>
                                            <ul>
                                        </div>
        ...
        <div id="intro-box" class="bg-image">
            ...
            <div id="carouselBasicExample" class="carousel slide carousel-fade" data-mdb-ride="carousel"
                ...
                <div class="carousel-inner slider">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/frotas_banner.png);">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/maquinaria_banner.png);">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/saude_banner.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
                                <h1 class="mb-5 title">Cuide do seu activo mais valioso!</h1>
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/engenharias_banner.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/incendio_banner_1.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/negocios_banner.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/respCivil_banner.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
                                <h1 class="mb-5 title">Construa com segurança. Construa sem medo…!</h1>
                    ...
                    <!-- Single item -->
                    <div class="carousel-item slider"
                        style="background-image: url(../assets/img/slides/PME_banner.png);">
                        <div class="content d-flex justify-content-start align-items-center h-100 p-5"
                            style="z-index: 99999; max-width: 450px;">
                            <div class="text-white text-center text-md-start">
        ...
        <section class="box">
            <div class="box-center" style="max-width: 1200px;">
                <div class="header-content-main">
                    <h4>
                        O Seguro de Acidentes de Trabalho garante aos empregados da empresa ou estabelecimento, a
                        compensação pelos danos sofridos em caso de acidente, ocorrido durante o horário de trabalho ou
                        no percurso de ida e volta para o local de trabalho. É um seguro obrigatório por lei, ficando o
                        empregado protegido, por exemplo, contra uma eventual incapacidade temporária ou permanente,
                        provocada pela actividade profissional.
                    </h4>
                </div>
                <div class="table-producto">
                    <div class="table-header">
                        <div class="item-container">
                            <div class="table-item dif"
                                style="background: url(../assets/img/slides/AcidentesdeTrabalho.jpg);"></div>
                            ...
                            <div class="table-item">
                                <h2>Básico</h2>
                                <p>O pacote básico garante a protecção dos seus empregados em casos de acidentes que
                                    ocorram no local de trabalho ao limite da cobertura</p>
                            </div>
                            <div class="table-item">
                                <h2>Executivo</h2>
                                <p>Neste pacote, o empregado se beneficia de cobertura em caso de acidente que ocorra na
                                    ida ou regresso do local de trabalho, quando usado o meio de transporte particular,
                                    bem como assistência em hospitais e clínicas privadas.</p>
                            </div>
                            <div class="table-item">
                                <h2>Elite</h2>
                                <p>Para além das coberturas principais, o pacote Elite oferece maior protecção ao seu
                                    empregado, com cobertura em casos de morte ou incapacidade, bem como tratamento
                                    especializado.</p>
                            </div>
                        </div>
                    </div>
                    <div class="table-content">
                        <ul class="content-list">
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Ocorrem na ida e no regresso entre a residência habitual e o local de trabalho,
                                        quando utilizado meio de transporte fornecido pelo empregador, ou quando o
                                        acidente seja consequência de particular perigo do percurso normal ou de outras
                                        circustâncias que tenham agravado o risco do mesmo percurso</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Ocorram na ida e no regresso entre a residência habitual e o local de trabalho
                                        quando utilizado meio de transporte particular, transporte semi-colectivo ou
                                        colectivo de passageiros ou peão</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Se verifiquem antes ou depois da prestação do trabalho, desde que directamente
                                        relacionados com a prestação ou termo dessa prestação</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Se verifiquem por ocasião da prestação do trabalho fora do local e tempo do
                                        trabalho normal, se verificar enquanto o trabalhador executa ordens ou realiza
                                        serviços sob direcção ou autoridade do empregador</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Ocorram durante a execução de serviços, ainda que não profissionais, fora do
                                        local e tempo de trabalho, prestados esporadicamente pelo trabalhador ao
                                        empregador de que possa resultar proveito económico para este</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Se verifiquem no local onde ao trabalhador deve ser prestado qualquer forma de
                                        assistência ou tratamento em virtude de anterior acidente e enquanto alí
                                        permanecer para esses fins</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                        ...
                        <ul class="content-list">
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Hospitalização, internamento e tratamento em estabelecimentos hospitalares
                                        públicos nacionais</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                            ...
                            <li class="list-item info">
                                <div class="col-name lv2">
                                    <p>Despesas de transporte e acomodação de terceira pessoa (acompanhante) sempre que
                                        necessário e, enquanto durar o tratamento</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                                        <span><i class='bx bx-check'></i></span>
                            ...
                            <li class="list-item info ">
                                <div class="col-name lv2 d-block">
                                    <p>Toda e qualquer não orriginada pelo exercício da acividade profissional
                                        (Acidentes pessoais) conforme os limites abaixo</p>
                                    <p class="small">1. Morte</p>
                                    <p class="small">2. Incapacidade Permanete- Percentagem determinada pelo grau de
                                        incapacidade de acordo com a escala da função pública</p>
                                    <p class="small">3. Incapacidade temporária - 100% dos ganhos semanais medidos com
                                        base nos ganhos anuais assumidos</p>
                                    <p class="small">4. Despesas médicas incorridas como resultado de um acidente
                                        coberto</p>
                                </div>
                                <div class="col-detalh">
                                    <p>
                            ...
                            <div class="row column-splitter">
                                        ...
                                        <div class="promo">
                                            <div class="content">
                                                <a class="btn btn-contacts" href="#cotacao">
                                                    <figure>
                                                        <img src="../assets/img/Outros_icones_Simulador-01.png"
                                                            alt="">
                                                    </figure>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                    <div class="row">
                                        <div class="promo">
                                            <div class="content">
                                                <a class="btn btn-contacts" href="../assets/documents/WCA.pdf.pdf">
                                                    <figure>
                                                        <img src="../assets/img/Outros_icones_Participação_Sinistro-01.png"
                                                            alt="">
                                                    </figure>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                ...
                                <p class="subtitle">Peça uma simulação e seja contactado(a) por um profissional. Sem
                                    compromisso.</p>
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    novalidate enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nome Completo</label>
                                        <input type="hidden" name="product" value="Acidentes de Trabalho">
                                    ...
                                    <div class="mb-3">
                                        <label for="numberMobile" class="form-label">Telefone</label>
                                        <input type="number" id="numberMobile"
                                            class="form-control @error('numberMobile') is-invalid @enderror"
                                            name="numberMobile" required>
                                        @if ($errors->has('numberMobile'))
                                            <span class="text-danger">{{ $errors->first('numberMobile') }}</span>
                                        @endif
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <button class="btn btn-primary btn-indico" type="submit">Contacte-me</button>
                                </form>
                            </div>
                        </div>
                    </div>
