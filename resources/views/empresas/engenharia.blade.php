...
<head>
    ...
    <title>Engenharia | ÍNDICO SEGUROS</title>
                ...
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        <div class="title-bar">
                            ...
                            <h4 class="title">Engenharia</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">O seguro de engenharia protege contra perdas financeiras de eventos
                                que possam ocorrer durante um projecto de construção civil ou engenharia mecânica em
                                armazéns de depósitos, asilos, casas residenciais, cinemas e auditórios, colégios,
                                edifícios comerciais, edifícios de apartamentos, edifícios de escritórios, edifícios
                                industriais, ginásios de exporte, hospitais e sanatórios, hotéis, igrejas, lojas de
                                departamentos, teatros e salas de concerto.</p>
                            <small>Engloba as seguintes sub-classes de negócio</small>
                            <ul class="" style="list-style: none;">
                                <li><span><i class='bx bx-check me-2'></i>Seguro de empreitada</span></li>
                                <li><span><i class='bx bx-check me-2'></i>Seguro de montagem</span></li>
                                <li><span><i class="bx bx-check me-2"></i>Avaria de máquina</span></li>
                                <li><span><i class="bx bx-check me-2"></i>Máquina Casco</span></li>
                                <li><span><i class="bx bx-check me-2"></i>Equipamento electrónico</span></li>
                            </ul>
                        </div>
                                                ...
                                                <div class="promo">
                                                    <div class="content">
                                                        <a class="btn btn-contacts"
                                                            href="../assets/documents/Seguro_Empreitada.pdf">
                                                            <figure>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/eng_larg.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">Engenharia</p>
                                ...
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Engenharia">
