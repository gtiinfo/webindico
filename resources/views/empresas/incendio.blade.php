...
<head>
    ...
    <title>Incêndio | ÍNDICO SEGUROS</title>
                ...
                <div class="component-content">
                    <div class="row">
                        <div class="component rich-text col-12 position-center">
                            <div class="component-content">
                                <h2 style="text-align: center;">Incêndio</h2>
                            </div>
                        </div>
                                                            ...
                                                            <table class="indico-table">
                                                                <thead>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Coberturas</h4>
                                                                            <h5>O que está incluído</h5>
                                                                        </th>
                                                                        ...
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                            <h4>Clássico</h4>
                                                                        </th>
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Exclusivo</h4>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Incêndio, acção mecânica de queda de
                                                                                Raio e Explosão</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                            </h4>
                                                                        </th>
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Queda de Aeronaves e/ou de aparelhos
                                                                                aéreos análogos ou de objectos deles
                                                                                caídos</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Derrame de Sistemas Hibraúlicos de
                                                                                Protecção contra incêndio</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-check'></i></h4>
                                                                        </th>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Choque ou Impacto de Veículos Terrestes
                                                                                ou Animais</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-check'></i></h4>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Greves, Tumultos e alteração da órdem
                                                                                pública (Riscos não políticos)</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                            </h4>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Actos de vandalismo, Maliciosos ou de
                                                                                Sabotagem</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                ...
                                                                <tbody>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                            <h4>Sim<br>
                                                                                (Capital limitado ao valor
                                                                                correspondente ao equipamento
                                                                                electrónico e
                                                                                maquinaria com o máximo de MZN
                                                                                500,000.00)</h4>
                                                                        </th>
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            ...
                                                                            <h4>Sim<br>
                                                                                (capital limitado ao valor
                                                                                correspondente ao equipamento com o
                                                                                máximo de MZN
                                                                                250,000.00)</h4>
                                                                        </th>
                                                                        <th
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Sim<br>
                                                                                1% do capital seguro com o máximo de MZN
                                                                                50,000.00</h4>
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                            <h4>Sim<br>
                                                                                1.5% do capital seguro com o máximo de
                                                                                MZN 200,000.00</h4>
                                                                        </th>
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Sim<br>
                                                                                2% do capital seguro com o máximo de MZN
                                                                                450,000.00</h4>
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Avarias de Frigorificos e Arcas
                                                                                Congeladoras</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                        ...
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Sim<br>
                                                                                0.20% do capital seguro com o máximo de
                                                                                MZN 75,000.00</h4>
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                            <h4>Sim <br>
                                                                                0.10 % do capital seguro com o máximo de
                                                                                MZN 50,000.00</h4>
                                                                        </th>
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Sim<br>
                                                                                2 % do capital seguro com o máximo de
                                                                                MZN 500,000.00</h4>
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        ...
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Renda máxima mensal de MZN 80,000.00 com
                                                                                maximo de 90 dias</h4>
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Privação Temporária do uso do local da
                                                                                Habitação</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Responsabilidade civil extracontratual
                                                                            </h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Furto ou roubo e danos no edifício por
                                                                                furto ou roubo</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Quebra Isolada e acidente de Vidros,
                                                                                espelhos e louças sanitária</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4>Sim<br>
                                                                                1 % do capital seguro com o máximo de
                                                                                MZN 750,000.00</h4>
                                                                        </th>
                                                                        <th
                                                                            class="indico-table-reTableHeaderEvenCol-1">
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Responsabilidade Civil Empregados
                                                                                Domésticos</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                        ...
                                                                        <th
                                                                            class="tranquilidade-table-reTableHeaderLastCol-1">
                                                                            <h4>Sim<br>
                                                                                0,5% do capital seguro com o máximo de
                                                                                MZN 1,000,000.00</h4>
                                                                        </th>
                                                                    </tr>
                                                            ...
                                                            <table class="indico-table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Cláusula relativa aos Encargos com o
                                                                                Corpo de Bombeiros</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                            </h4>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Cláusula relativa aos Honorários de
                                                                                Arquitectos, Advogados e de outros
                                                                                Profissionais</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Cláusula relativa ao Custo de Demolição,
                                                                                de Limpeza e de Construção de tapumes
                                                                            </h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Cláusula relativa a Encargos
                                                                                relacionados com a Extinção de Incêndios
                                                                            </h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                                                    ...
                                                                    <tr class="indico-table-reTableHeaderRow-1">
                                                                        <th
                                                                            class="indico-table-reTableHeaderFirstCol-1">
                                                                            <h4>Cláusula relativa aos Honorários
                                                                                referentes ao Escrutínio das Plantas
                                                                                Municipais</h4>
                                                                        </th>
                                                                        <th class="indico-table-reTableHeaderOddCol-1">
                                                                            <h4><i class='bx bx-x text-danger'></i>
                                    ...
                                    <div class="promo">
                                        <div class="content">
                                            <a class="btn btn-contacts"
                                                href="../assets/documents/Seguro_Incendio.pdf">
                                                <figure>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/incendio_land.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">Incêndio</p>
                                ...
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Incêndio">
