...
<head>
    ...
    <title>Multirisco Negócios | ÍNDICO SEGUROS</title>
                ...
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        <div class="title-bar">
                            ...
                            <h4 class="title">Multiriscos Negócios</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">Se é proprietário de uma loja de vestuário, de um estabelecimento
                                de comércio alimentar como um minimercado, um talho ou uma padaria, ou se detém uma loja
                                de decoração, ou uma loja de brinquedos, uma livraria ou uma tabacaria, ou ainda, se tem
                                um escritório de advocacia, um atelier de arquitetura, uma sociedade de mediação
                                imobiliária ou uma farmácia, a ÍNDICO tem a solução ideal para si. A nova Solução
                                Negócios (Comércio & Serviços) permite-lhe subscrever, de forma simples e integrada, os
                                vários seguros essenciais ao seu negócio, abrangendo o escritório ou estabelecimento, o
                                seu recheio, os veículos, a protecção dos seus trabalhadores e ainda as
                                responsabilidades da sua empresa.</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/negecio_larg.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">Multirisco Negócios</p>
                                ...
                                <form action="/empresas/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Multirisco Negócios">
