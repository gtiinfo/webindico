      ...
      <div class="">
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            ...
            <div class="content">
              <p class="content-text">Se é proprietário de uma loja de vestuário, de um estabelecimento de comércio alimentar como um minimercado, um talho ou uma padaria, ou se detém uma loja de decoração, ou uma loja de brinquedos, uma livraria ou uma tabacaria, ou ainda, se tem um escritório de advocacia, um atelier de arquitetura, uma sociedade de mediação imobiliária ou uma farmácia, a ÍNDICO tem a solução ideal para si. A nova Solução Negócios (Comércio & Serviços) permite-lhe subscrever, de forma simples e integrada, os vários seguros essenciais ao seu negócio, abrangendo o escritório ou estabelecimento, o seu recheio, os veículos, a protecção dos seus trabalhadores e ainda as responsabilidades da sua empresa.</p>
