...
$amount="3500.00";
$returnUrl="http://indico.bluteki.com/empresas/pay.php";
$currency="MZN";
...
<script src="https://test-millenniumbim.mtf.gateway.mastercard.com/checkout/version/49/checkout.js" data-error="errorCallback" data-cancel="http://indico.bluteki.com/empresas/pay.php"></script>

<script type="text/javascript">
	function errorCallback(error){
		alert("ERROR: " + JSON.stringify(error));
		window.location.href = "http://indico.bluteki.com/empresas/pay.php";
	}
