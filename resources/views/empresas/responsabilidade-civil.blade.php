...
<head>
  ...
  <title>Responsabilidade Civil Geral | ÍNDICO SEGUROS</title>
        ...
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            <div class="title-bar">
              ...
              <h4 class="title">Responsabilidade Civil Geral</h4>
            </div>
            <div class="content">
              <p class="content-text">O Seguro de Responsabilidade Civil Geral também chamada RC Comercial cobre danos
                ou ferimentos causados a terceiros durante o decurso normal das actividades do segurado e tem por
                finalidade reembolsar o segurado por responsabilidades civis pelas quais possa ser condenado, por danos
                materiais, corporais e morais e por custos e despesas causados a terceiros quando decorrentes de riscos
                contratados na apólice </p>
              <small>Funções</small>
              <ul class="" style="list-style: none;">
                <li><span><i class='bx bx-check me-2'></i>Defender</span></li>
                <li><span><i class='bx bx-check me-2'></i></i>Indemnizar</span></li>
              </ul>
            </div>
                        ...
                        <div class="promo">
                          <div class="content">
                            <a class="btn btn-contacts"
                              href="../assets/documents/CG_DP_02_R0 Seguro de Acidentes Pessoais Grupo.pdf">
                              <figure>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12">
                <div class="component-content">
                  <h3 class="text-center mt-5 title">Garantias Aplicáveis</h3>
                </div>
              </div>
              <div class="">
                <div class="component-content">
                  <div class="gallery-content">
                    <div class="gallery-card">
                      <div>
                        ...
                        <span>Garantia de exercício da actividade do segurado a nível do territorio nacional</span>
                      </div>
                    </div>
                    <div class="gallery-card border-end-0">
                      <div>
                        ...
                        <span>Prazo máximo de 2 anos após a ocorrência do sinistro para efeitos de reclamação.</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
              <div class="img-cotacao">
                <img src="../assets/img/slides/resp_civil_larg.jpg" alt="">
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
              <div class="form-cotacao">
                <p class="title">Responsabilidade Civil Geral</p>
