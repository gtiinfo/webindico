        ...
        <section class="box">
            <div class="box-center" style="max-width: 1200px;">
                <div class="header-content-main">
                    <h4>
                        Oferecemos-lhe um seguro muito completo para o seu automóvel, com uma oferta muito abrangente e
                        com um
                        excelente serviço de assistência associado através das nossas empresas de gestão de risco e
                        oficina de
                        colisão. O seguro garante a cobertura de danos causados a terceiros, igualmente, a reparação
                        pelos danos
                    ...
                    <div class="table-header">
                        <div class="item-container">
                            ...
                            <div class="table-item">
                                ...
                                <h2>Básico</h2>
                                <p>É o pacote que visa garantir cobertura aos danos que possam ser causados pelo
                                    condutor do veículo
                                    seguro em consequência de choque, colisão, capotamento, morte ou invalidez, despesas
                                    médicas, funeral
                            ...
                            <div class="table-item">
                                ...
                                <h2>Clássico</h2>
                                <p>Oferecemos-lhe aqui a acobertura ao seu veículo em casos de incêndio, furto ou roubo
                                    e reboque da sua
                            ...
                            <div class="table-item">
                                ...
                                <h2>Exclusivo</h2>
                                <p>No pacote exclusivo de danos próprios, o condutor do veículo seguro usufrui de todos
                                    os benefícios do
                                    pacote clássico e está coberto em casos de fenómenos da natureza e não paga franquia
                                    em casos de
                                        ...
                                        <div class="promo">
                                            <div class="content">
                                                <a class="btn btn-contacts"
                                                    href="../assets/documents/Seguro_Automovel_v01.pdf">
                                                    <figure>
