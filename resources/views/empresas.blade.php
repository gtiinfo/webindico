...
<head>
  ...
  <title>Empresas | ÍNDICO SEGUROS</title>
      ...
      <li class="bg-bk">
        ...
        <ul>
          <li>
            ...
            <div class="text">
              <label for=""><a href="{{ __(route('view.danos-proprios-emp')) }}">Automóvel</a></label>
            </div>
          </li>
          <li>
            <div class="icon me-2">
      ...
      <div class="insurance">
        <div class="container mt-5 pl-3 pr-3">
          ...
          <ul class="insurance-list">
            ...
            <li><a href="{{ __(route('view.acidente-trabalho')) }}">
                <img src="./assets/img/IconsTiposSeguro_AcidentesTrabalho.png" alt="">
                <p>Acidentes de Trabalho</p>
              </a>
            </li>
            <li><a href="{{ __(route('view.negocio')) }}">
                <img src="./assets/img/IconsTiposSeguro_Negocios.png" alt="">
                <p>Negócios</p>
              </a>
            </li>
            <li><a href="{{ __(route('view.incendio')) }}">
                <img src="./assets/img/IconsTiposSeguro_Habitacao.png" alt="">
                <p>Incêndio</p>
              </a>
            </li>
            <li><a href="{{ __(route('view.saude')) }}">
                <img src="./assets/img/IconsTiposSeguro_Engenharias.png" alt="">
                <p>Engenharias</p>
              </a>
            </li>
            <li><a href="{{ __(route('view.pme')) }}">
                <img src="./assets/img/IconsTiposSeguro_PME.png" alt="">
                <p>PMEs</p>
              </a>
            </li>
          </ul>
      ...
      <div class="container mt-5">
        <div class="info-one">
          <div class="row-one card-inf d-flex justify-content-center">
            <a href="{{ __(route('view.sinistro-emp')) }}">
            ...
            <a href="{{ __(route('view.cons-sinistro-emp')) }}">
          ...
          <a href="{{ __(route('view.danos-proprios-emp')) }}">
            <div class="row-one card-inf d-flex justify-content-center">
