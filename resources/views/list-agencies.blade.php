                                                        ...
                                                        <ul class="tabs-body">
                                                            ...
                                                            <div class="item-0">
                                                                ...
                                                                <div class="list-item">
                                                                    ...
                                                                    <ul>
                                                                        <li class="dropdown0 icon-menu-drop">Denúcia
                                                                        </li>
                                                                        <ul class="dropdown1">
                                                                            <li><a
                                                                                    href=" {{ __(route('view.parti-fraude-part')) }}">Participar
                                                                                    de Fraude</a></li>
                                                                            <li><a
                                        ...
                                        <li>
                                            <div class="container1 item-area">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="{{ __(route('view.parti-fraude-part')) }}">Participar
                                                            Fraude</a></li>
                                                    <li><a
                                                            href="{{ __(route('view.reclamacoes-part')) }}">Reclamações</a>
                                                    </li>
            ...
            <li class="bg-bk">
                ...
                <ul>
                    <li>
                        ...
                        <div class="text">
                            <label for=""><a href="#">Automóvel</a></label>
                        </div>
                    </li>
                    <li>
                        <div class="icon me-2">
                        ...
                        <div class="text">
                            <label for=""><a href="#">Viagem</a></label>
                        </div>
                    </li>
                    <li>
                        <div class="icon me-2">
                        ...
                        <div class="text">
                            <label for=""><a href="#">Funeral</a></label>
                        </div>
                    </li>
                    <li>
                        <div class="icon me-2">
                        ...
                        <div class="text">
                            <label for=""><a href="#">Acidente de Trabalho</a></label>
                        </div>
                    </li>
                </ul>
                <div class="img-bottom"></div>
