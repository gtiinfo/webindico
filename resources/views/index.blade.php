...
<head>
    ...
    <title>Particulares | ÍNDICO SEGUROS</title>
...
<body>
            ...
            <li class="bg-bk">
                ...
                <ul>
                    <li>
                        ...
                        <div class="text">
                            <label for=""><a
                                    href="https://api.whatsapp.com/send?phone=+2588502727270&text=&source=&data="
                    ...
                    <li>
                        ...
                        <div class="text">
                            <a href="#" class="text-light">
                                <div class="d-flex">
                                    <img src="./assets/img/Icones_Contacto.png" width="30" style="height: 37px;"
                                        alt="">
            ...
            <li class="bg-bk">
                ...
                <ul>
                    <li>
                        ...
                        <div class="text">
                            <label for="{{ __(route('view.danos-proprios-part')) }}"><a
                                    href="">Automóvel</a></label>
                        </div>
                    </li>
                    <li>
                        <div class="icon me-2">
    ...
    <section class="article p-0 m-0" id="article">
        <div class="d-flex flex-wrap">
            <div class="insurance">
                <div class="container mt-5 pl-3 pr-3">
                    <h4>Simule um seguro e viva sem medo</h4>
                    <ul class="insurance-list">
                        <li><a href="{{ __(route('view.danos-proprios-part')) }}">
                                <img src="./assets/img/IconsTiposSeguro_Auto.png" alt="">
                                <p>Auto</p>
                            </a>
                        </li>
                        <li><a href="{{ __(route('view.habitacao')) }}">
                                <img src="./assets/img/IconsTiposSeguro_Habitacao.png" alt="">
                                <p>Habitação</p>
                            </a>
                        </li>
                        <li><a href="{{ __(route('view.viagem-part')) }}">
                                <img src="./assets/img/IconsTiposSeguro_Viagem.png" alt="">
                                <p>Viagem</p>
                            </a>
                        </li>
                        <li><a href="{{ __(route('view.funeral')) }}">
                                <img src="./assets/img/IconsTiposSeguro_Funeral.png" alt="">
                                <p>Funeral</p>
                            </a>
                        </li>
                        <li><a href="{{ __(route('view.acidente-pessoal')) }}">
                                <img src="./assets/img/IconsTiposSeguro_Acidentes.png" alt="">
                                <p>Acidente Pessoal</p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container mt-5">
                <div class="info-one">
                    <div class="row-one card-inf d-flex justify-content-center">
                        <a href="{{ __(route('view.sinistros-part')) }}">
                        ...
                        <a href="{{ __(route('view.consul-sinistro-part')) }}">
                    ...
                    <a href="javascript:void(0)" class="participarSinistro">
                        <div class="row-one card-inf d-flex justify-content-center">
                    ...
                    <div class="popup" id="popup">
                        <h2>Tipo de Simulação</h2>
                        <select id="tipoSimulacao" class="form-control">
                            <option selected>Selecione o tipo de Simulação</option>
                            <option value="rc">Responsabilidade Civil</option>
                            <option value="dp">Danos Proprios</option>
                        </select>
                        <button id="btnSimular">Participar</button>
                    </div>

                </div>
                <div class="info-two mt-5">
                    <h4>Estamos nas Suas Mãos</h4>
