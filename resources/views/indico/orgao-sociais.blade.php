...
<head>
    ...
    <title>Orgãos Sociais | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Orgãos Sociais</h4>
                    </div>
                    <div class="content">
                        <table class="table table-sm text-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    <td>Presidente</td>
                                    <td>Dr. Alfiado Pascoal</td>
                                </tr>
                                <tr>
                                    <td>Secretária</td>
                                    <td>Dra. Juliana Penicela</td>
                                </tr>
                                <tr>
                                    <th colspan="2">
                                        <h4>&nbsp;</h4>
                                ...
                                <tr>
                                    <td>Presidente Não Executivo</td>
                                    <td>PhD Mário Sitoe</td>
                                </tr>
                                <tr>
                                    <td>Administrador Não Executivo</td>
                                    <td>Dr. Helder Santos</td>
                                </tr>
                                <tr>
                                    <td>Administrador Executivo</td>
                                    <td>Dr. Ruben Chivale</td>
                                </tr>
                                <tr>
                                    <td>Administrador Executivo</td>
                                    <td>Dr. Olivio Melembe</td>
                                </tr>
                                <tr>
                                    <td>Administradora Executiva</td>
                                    <td>Dra. Nasma Omar</td>
                                </tr>
                                <tr>
                                    <th colspan="2">
                                        <h4>&nbsp;</h4>
                                        <h4>Comissão Executiva</h4>
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Administrador do Pelouro de Adminstração e Finanças</td>
                                    <td>Dr. Olivio Melembe</td>
                                </tr>
                                <tr>
                                    <td>Administradora do Pelouro de Operações</td>
                                    <td>Dra. Nasma Omar</td>
                                </tr>
                                <tr>
                                    <th colspan="2">
                                ...
                                <tr>
                                    <td>I2A Consultoria.</td>
                                    <td>Dr. Ismael Faquir</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
