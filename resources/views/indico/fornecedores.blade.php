...
<head>
    ...
    <title>Os Nossos Fornecedores | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 450px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Cadastro de Fornecedores</h4>
                    </div>
                    <div class="content mb-4">
                        <form action="/indico/email/fornecedores" class="needs-validation" novalidate enctype="multipart/form-data">
                            @csrf
                            <div class="component-container mx-auto">
                                <div class="mt-2 has-validation">
                                    <label for="" class="fw-bold">Nome Próprio<span
                                            class="text-danger">*</span></label>
                                    <input type="hidden" value="Cadastro de Fornecedores" name="parceiria">
