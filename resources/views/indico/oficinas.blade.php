...
<head>
    ...
    <title>Oficinas Recomendadas | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 450px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Cadastro de Oficinas</h4>
                    </div>
                    <div class="content mb-4">
                        <form action="/indico/email/oficinas" class="needs-validation" novalidate enctype="multipart/form-data">
                            @csrf
