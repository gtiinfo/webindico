...
<head>
    ...
    <title>Documentos Institucionais | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Documentos Institucionais</h4>
                    </div>
                    <div class="content">
                        <ul class="list-docs">
                            <li><a href="../assets/documents/Licenca_ISSM.pdf">Licença do Intituto de Supervisão de
                                    Seguros
                                    de Moçambique</a></li>
                            <li><a href="../assets/documents/Licenca_Servico_Telecomunicacoes_Valor_Acrescentado.pdf">Licença
                                    de Serviço de Telecomunicaçóes de Valor Acrescentado</a></li>
                            <li><a href="../assets/documents/Certidao_Comercial.pdf">Certidão De Registo nas
                                    Identidades
                                    Legais</a></li>
                            <li><a href="../assets/documents/NUIT_TAX_NUMBER.pdf">Número Único de Identificação
                                    Tributaria</a></li>
                            <li><a href="../assets/documents/Companhia_Seguros_Indico.pdf">Certificação de
                                    Companhia de Seguros Índico 2022</a></li>
                            <li><a href="../assets/documents/GI_Companhia_Seguros_Indico.pdf">Certificação de Companhia
                                    de Seguros Índico 2021</a></li>
                            <li><a href="../assets/documents/CEP_Companhia_Seguros_Indico.pdf">Certificação de
                                    Companhia de
                                    Seguros Índico 2019</a></li>
                            <li><a href="../assets/documents/Certidao.pdf">Licença - Microsseguros</a></li>
                        </ul>
                    </div>
