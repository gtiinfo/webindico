...
<head>
    ...
    <title>Certificações | ÍNDICO SEGUROS</title>
            ...
            <div class="gallery-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="../assets/img/iso/As ISO's Isoladas-01.png"><img
                                src="../assets/img/iso/As ISO's Isoladas-01.png" class="img-fluid"
                                alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="../assets/img/iso/As ISO's Isoladas-02.png"><img
                                src="../assets/img/iso/As ISO's Isoladas-02.png" class="img-fluid"
                                alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="../assets/img/iso/As ISO's Isoladas-03.png"><img
                                src="../assets/img/iso/As ISO's Isoladas-03.png" class="img-fluid"
                                alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="../assets/img/iso/As ISO's Isoladas-04.png"><img
                                src="../assets/img/iso/As ISO's Isoladas-04.png" class="img-fluid"
                                alt=""></a></div>
                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                            href="../assets/img/iso/As ISO's Isoladas-0.png"><img
                                src="../assets/img/iso/As ISO's Isoladas-05.png" class="img-fluid"
                                alt=""></a></div>
                </div>
