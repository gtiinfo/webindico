...
<head>
    ...
    <title>Dados da Empresa | ÍNDICO SEGUROS</title>
                ...
                <div class="box-medium">
                    <div class="box-row">
                        <div class="column">
                            <div class="title-bar">
                                ...
                                <h4>Denominação Social</h4>
                            </div>
                            <div class="content">
                                <p class="ms-2">Companhia de Seguros Índico S.A.</p>
                            </div>
                        </div>
                        <div class="column ms-2">
                            <div class="title-bar">
                                <h4>Denominação Comercial</h4>
                            </div>
                            <div class="content">
                                <p>Índico Seguros</p>
                            </div>
                    ...
                    <div class="box-row">
                        <div class="column">
                            <div class="title-bar">
                                <div class="title-icon"></div>
                                <h4>Sector de Actividade</h4>
                            </div>
                            <div class="content">
                                <p class="ms-2">Seguros</p>
                            </div>
                        </div>
                        <div class="column ms-2">
                            <div class="title-bar">
                            ...
                            <div class="content">
                                <p>Bairro Sommershield, Avenida Barnabé Thawé, n 333/659, Cidade de Maputo</p>
                            </div>
                        </div>
                    </div>
                    <div class="box-row">
                        <div class="column">
                            <div class="title-bar">
                                <div class="title-icon"></div>
                                <h4>Dados da Entidade Legal</h4>
                            </div>
                            <div class="content sub">
                                <h5 class="ms-2">Número</h5>
                                <p class="ms-2">100234963</p>
                            </div>
                            <div class="content sub">
                                <h5 class="ms-2">Capital Social</h5>
                                <p class="ms-2">365,000,000.00 MZN</p>
                            </div>
                        </div>
                        <div class="column ms-2">
                            <div class="title-bar">
                                <h4 class="mt-lg-3">&nbsp</h4>
