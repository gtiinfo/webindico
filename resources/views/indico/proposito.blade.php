...
<head>
    ...
    <title>Identidade Corporativa | ÍNDICO SEGUROS</title>
                ...
                <div class="box-medium">
                    <div class="box-row">
                        <div class="column">
                            ...
                            <div class="content">
                                <p class="ms-2">Servir e ser significante para a sociedade</p>
                            </div>
                        </div>
                        <div class="column ms-2">
                            ...
                            <div class="content">
                                <p>Proteger as famílias e as empresas através do pagamento justo e célere das suas
                                    perdas</p>
                            </div>
                        </div>
                    </div>
                    <div class="box-row">
                        <div class="column">
                            ...
                            <div class="content sub">
                                <h5 class="ms-2">Honestidade</h5>
                                <p class="ms-2">Agimos sempre com justiça, transparência, integridade e sinceridade
                                </p>
                            </div>
                            <div class="content sub">
                                <h5>Excelência</h5>
                                <p>Não nos conformamos com o bom e acreditamos que o perfeito pode ser aperfeiçoado</p>
                            </div>
                        </div>
                        <div class="column">
                            <div class="title-bar">
                                <h4 class="mt-lg-2">&nbsp</h4>
                            </div>
                            <div class="content sub">
                                <h5>Consistência</h5>
                                <p>Pensamos e agimos de forma disciplinada e coerente elevando cada vez mais os nossos
                                    padrões de
                                    serviço</p>
                            </div>
                            <div class="content sub">
                                <h5>Resiliência</h5>
                                <p>Antecipamo-nos para os desafios, adaptamo-nos facilmente e contornamos agilmente os
                                    obstáculos,
                                    tornando-nos cada vez mais fortes e determinados</p>
                            </div>
                        </div>
                    </div>
                    <div class="box-row">
                        <div class="column">
                            <div class="title-bar">
                                <div class="title-icon"></div>
                                <h4>As nossas Práticas</h4>
                            </div>
                            <div class="content">
                                <ul>
                                    <li><span>Ouvir mais do que ser ouvido;</span></li>
                                    <li><span>Compreender mais do que ser compreendido;</span></li>
                                    <li><span>Dar mais do que receber;</span></li>
                                    <li><span>Fazer o que é correcto ainda que tal nos prejudique;</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="column">
                            <div class="title-bar">
                                <h4>O Nosso Compromisso</h4>
                            </div>
                            <div class="content">
                                <p>Somos uma empresa cidadã, comprometida com o desenvolvimento socioeconómico, cultural
                                    e ambiental da
                                    comunidade e de todas as partes interessadas.</p>
                            </div>
                        </div>
                    </div>
