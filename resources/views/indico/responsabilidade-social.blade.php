...
<head>
    ...
    <title>Responsabilidade Social | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 650px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Responsabilidade Social Corporativa</h4>
                    </div>
                    <div class="content">
                        <p>
                            A nossa Responsabilidade Social Corporativa é feita através da Fundação Índico com o
                            objectivo:
                        <ul>
                            <li><span>Promover e apoiar iniciativas de Apoio Social;</span></li>
                            <li><span>Promover e defender os Direitos Humanos; e</span></li>
                            <li><span>Promover e desenvolver a Educação.</span></li>
                        </ul>
                        </p>
                        <p class="link-area" style="text-align: right;"><a class="link text-capitalize"
                                href="#">Saiba mais!</a></p>
                    </div>
