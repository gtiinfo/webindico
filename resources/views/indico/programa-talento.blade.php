...
<head>
    ...
    <title>Programa de Talentos | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 650px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Programa de Talentos</h4>
                    </div>
                    <div class="content">
                        <p>No âmbito da Responsabilidade Social Corporativa e visando o reforço do seu sistema de ESG, a
                            ÍNDICO SEGUROS introduziu o programa de talentos que tem como objectivo, designadamente</p>
                        <ul class="" style="list-style: none;">
                            <li><span><i class='bx bx-check me-2'></i>Desenvolver, complementar e aperfeiçoar o
                                    saber-fazer e o saber-estar profissional dos Recém-Graduados, permitindo a sua
                                    inserção no mercado de trabalho</span></li>
                            <li><span><i class='bx bx-check me-2'></i></i>Proporcionar aos Recém-Graduados, acesso à
                                    informação, intercâmbio e experiência profissional prática</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Direccionar a actuação profissional dos
                                    Recém-Graduados, adequando-a às exigências do mercado</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Aumentar o conhecimento prático dos
                                    Recém-Graduados sobre novos conteúdos formativos nas áreas profissionais, de modo a
                                    permitir a sua integração em novas áreas ocupacionais no domínio da sua formação
                                    profissional ou académica</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Facilitar o recrutamento e integração dos
                                    Recém-Graduados no mercado de trabalho, através do apoio técnico prestado na
                                    realização de estágios pré-profissionais</span></li>
                        </ul>
                        <small>1. Benefícios</small>
                        <ul class="" style="list-style: none;">
                            <li><span><i class='bx bx-check me-2'></i>O programa de talentos, destina-se aos
                                    Recém-Graduados de todas as áreas de formação</span></li>
                        </ul>
                        <small>2. Requisitos</small>
                        <ul class="" style="list-style: none;">
                            <li><span><i class='bx bx-check me-2'></i>Ter o ensino superior concluído e/ou as cadeiras
                                    do curso concluídas;</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Idade igual ou inferior a 25 anos;</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Ter média final do curso igual ou superior a 14
                                    Valores.</span></li>
                        </ul>
                        <div class="mb-3">
