        ...
        <div class="">
            <div class="box-center">
                <div class="box-medium" style="max-width: 650px;">
                    ...
                    <div class="content">
                        <p>Caro Denunciante,</p>
                        <small>Por favor note:</small>
                        <ul style="list-style: none;">
                            <li><span><i class='bx bx-check me-2'></i>A denúncia de irregularidades, condutas
                                    antiéticas, crimes
                                    ou transgressões,
                                    não conduz à cessação de qualquer contrato que o denunciante tenha connosco.</span>
                            </li>
                            <li><span><i class='bx bx-check me-2'></i>Nenhum denunciante pode ser sancionado,
                                    discriminado ou
                                    hostilizado.</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Todos, sem excepção, têm o direito e dever de
                                    expressar e
                                    denunciar todas as
                                    condutas antiéticas, crimes ou transgressões que presenciar ou tomar conhecimento ou
                                    presenciar.</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Todo o denunciante deve ser protegido contra
                                    qualquer
                                    ameaça, discriminação
                                    ou retaliação, seja do foro profissional ou pessoal.</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Qualquer retaliação, ameaça ou discriminação é
                                    tida como
                                    abuso e deve ser
                                    adequadamente tratada.</span></li>
                            <li><span><i class='bx bx-check me-2'></i>Toda a denúncia é tratada de forma sigilosa,
                                    protegendo-se a
                                    identidade do
                                    denunciante.</span></li>
                            <li><span><i class='bx bx-check me-2'></i>A protecção ao denunciante é gratuita.</span>
                            </li>
                        </ul>
