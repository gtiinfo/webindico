...
<head>
    ...
    <title>Recrutamento | ÍNDICO SEGUROS</title>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/rec/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css" href="../assets/rec/css/venobox.css" />
...
<body>
    ...
    <!-- Box-Proposito -->
    <div class="fridge_serive_area" id="service">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="witr_section_title">
                        <div class="witr_section_title_inner text-center">
                            <h3  style="color:#00aeef">Recrutamento </h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../assets/rec/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="../assets/rec/assets/js/bootstrap.min.js"></script>
    <script src="../assets/rec/assets/js/isotope.pkgd.min.js"></script>
    <script src="../assets/rec/js/owl.carousel.min.js"></script>
    <script src="../assets/rec/js/jquery.nivo.slider.pack.js"></script>
    <script src="../assets/rec/js/slick.min.js"></script>
    <script src="../assets/rec/js/imagesloaded.pkgd.min.js"></script>
    <script src="../assets/rec/js/venobox.min.js"></script>
    <script src="../assets/rec/js/jquery.appear.js"></script>
    <script src="../assets/rec/js/jquery.knob.js"></script>
