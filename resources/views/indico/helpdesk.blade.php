...
<head>
    ...
    <title>Help Desk - Ética | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 550px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Help Desk - Ética</h4>
                    </div>
                    <div class="content">
                        <p>Caro Senhor/Senhora,</p>
                        <small>Por favor contacte-nos para:</small>
                        <ul>
                            <li><span>Esclarecimento de dúvidas sobre o nosso código de ética e conduta.</span></li>
                            <li><span>Esclarecimento de dúvidas sobre as nossas Políticas.</span></li>
                            <li><span>Orientação ética na sua interacção com a Índico Seguros.</span></li>
                        </ul>
                        <div class="form">
