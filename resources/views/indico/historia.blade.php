...
<head>
    ...
    <title>História | ÍNDICO SEGUROS</title>
                    ...
                    <div class="box-history">
                        <div class="card-item left">
                            ...
                            <ul style="padding-right: 15px;">
                                <li>Início de Actividades</li>
                                <li>Abertura do balcão de Ressano Garcia</li>
                                <li>Abertura do balcão Ponta D´Ouro</li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2012</h1>
                            <ul style="">
                                <li>International Golden Start for Quality (Paris)</li>
                                <li>Abertura da Agência de Chimoio</li>
                                <li>Abertura do Balcão de Machipanda</li>
                                <li>Abertura do Balcão Zóbwé</li>
                                <li>Abertura do Balcão de Cuchamano</li>
                                <li>Abertura do Balcão de Cassacatiza</li>
                            </ul>
                        </div>
                        <div class="card-item left">
                            <h1>2013</h1>
                            <ul style="padding-right: 15px;">
                                <li>Platinum Award for Excellence and Business Prestige (Nova York)</li>
                                <li>ESQR´S Quality Achivement Award (Londres)</li>
                                <li>Atribuição do Selo Made in Mozambique</li>
                                <li>Abertura da Agência da Beira</li>
                                <li>Membro da Organização Africana de Seguradoras</li>
                                <li>Abertura do Balcão de Goba</li>
                                <li>Abertura do Balcão de Expungabeira</li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2014</h1>
                            <ul style="">
                                <li>Century Quality Era Award (Genebra)</li>
                                <li>Abertura da Agência de Nacala</li>
                                <li>Abertura da Agência de Nampula</li>
                                <li>Superbrand Moçambique (2013-2014)</li>
                                <li>Abertura do Balcão de Milange</li>
                                <li>Lançamento e disponibilidade da plataforma "software" de gestão de seguros aos
                                    parceiros de negócio
                                </li>
                                <li>Abertura do Balcão de Namaacha</li>
                                <li>Abertura da Oficina de Bape Chapa e Pintura - Perfect Panel Beaters, SA</li>
                            </ul>
                        </div>
                        <div class="card-item left">
                            <h1>2015</h1>
                            <ul style="padding-right: 15px;">
                                <li>Abertura da Agência de Quelimane e Pemba</li>
                                <li>Superbrand Moçambique (2014-2015)</li>
                                <li>Lançamento da plataforma de participação de sinistros "online"</li>
                                <li>ançamento da plataforma de notificação automática "SM"</li>
                                <li>Membro da Associação Moçambicana de Seguradoras "AMS"</li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2016</h1>
                            <ul style="">
                                <li>Abertura da Agência de Maxixe</li>
                                <li>Mudança da Sede</li>
                                <li>Lançamento do alerta "SMS" notificações automáticas aos nossos clientes</li>
                            </ul>
                        </div>
                        <div class="card-item left">
                            <h1>2017</h1>
                            <ul style="padding-right: 15px;">
                                <li>Lançamento do Seguro de Responsabilidade Civil para venda nos postos de combustível
                                </li>
                                <li>Abertura da Agência de Tete</li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2018</h1>
                            <ul style="">
                                <li>Abertura da Agência de Xai-Xai</li>
                                <li>Lançamento do seguro de desemprego</li>
                                <li>Criação de Ceontro Integrado de Gestão de Riscos</li>
                            </ul>
                        </div>
                        <div class="card-item left">
                            <h1>2019</h1>
                            <ul style="padding-right: 15px;">
                                <li>Lançamento da app Android e IOS</li>
                                <li>Serviço USSD *315#</li>
                                <li>Certificação no sistema de Gestão de Qualidade na norma ISO 9001:2015 pela APCER
                                </li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2020</h1>
                            <ul style="">
                                <li>Lançamento da Agência Móvel</li>
                                <li>Abertura da Unidade de atendimento ao Cliente na sede</li>
                                <li>Criação de novos Produtos (Automóvel e Acidentes de Trabalho)</li>
                                <li>Melhor Seguradora pela pesquisa das 100 Maiores - KPMG</li>
                                <li>Maior quota de mercado no seguro automóvel</li>
                            </ul>
                        </div>
                        <div class="card-item left">
                            <h1>2021</h1>
                            <ul style="padding-right: 15px;">
                                <li>Lançamento do Seguro de Saúde</li>
                                <li>Abertura da Agência e Centro de Formação da Matola</li>
                                <li>Abertura da Agência da Manhiça</li>
                                <li>Contact Center</li>
                                <li>Certificação na norma ISO 27001</li>
                                <li>Aumento do Capital Social para MZN 300. 000,000.00</li>
                            </ul>
                        </div>
                        <div class="card-item right">
                            <h1>2022</h1>
                            <ul>
                                <li>Certificação na Norma ISO 22301</li>
                                <li>Aumento de Capital Social para MZN 365,000,000.00</li>
                            </ul>
                        </div>
                    </div>
