...
<head>
    ...
    <title>Recrutamento - Candidatura | ÍNDICO SEGUROS</title>
...
<body>
    ...
    <div class="content-page" style="margin-left: 0; min-height: calc(100vh - var(--ct-topbar-height) - 2px);">
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <h4 class="m-5 page-title">Candidaturas</h4>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="projectname" class="form-control" placeholder="Entre com o seu nome ">
                                        </div>

                                        <div class="mb-3">
                                            <label for="projectname" class="form-label">E-mail</label>
                                            <input type="text" id="projectname" class="form-control" placeholder="Entre com o seu endereço e-mail">
                                        </div>
                                        <div class="mb-3">
                                            <label for="project-budget" class="form-label">Telefone</label>
                                            <input type="text" id="project-budget" class="form-control" placeholder="Entre com o seu telefone">
                                        </div>
                                        <div class="mb-3">
                                            <label for="project-overview" class="form-label">Candidatura</label>
                                            
                                            <select class="form-control select2" data-toggle="select2">
                                                <option disabled>Select</option>
                                                <option value="">Contact Center</option>
                                    ...
                                    <div class="col-xl-6">
                                        {{-- <label for="project-budget" class="form-label">Anexos</label> --}}
                                        <div class="mb-3">
                                            <label for="project-budget" class="form-label">Curriculo Vitae</label>
                                            <input type="file" id="project-budget" class="form-control" placeholder="Entre com o seu telefone">
                                        </div>
                                        <div class="mb-3">
                                            <label for="project-budget" class="form-label">Bilhete de Identificão</label>
                                            <input type="file" id="project-budget" class="form-control" placeholder="Entre com o seu telefone">
                                        </div>
                                        <div class="mb-3">
                                            <label for="project-budget" class="form-label">Certificado de Habilitações Literaris</label>
                                            <input type="file" id="project-budget" class="form-control" placeholder="Entre com o seu telefone">
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <button class="btn btn-danger" type="submit"><i
                                                class="uil-arrow-growth me-2"></i>Enviar</button>
                                    </div>
                                </div>
                                <!-- end row -->
