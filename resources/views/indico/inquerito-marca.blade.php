                    ...
                    <div class="content">
                        <form action="" class="needs-validation" novalidate>
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">Qualidade do declarante<span
                                        class="text-danger">*</span></label>
                                <div class="d-flex">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Tomador de Seguro</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Visitante</label>
                                    </div>
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">1. O que a marca Índico Seguros lhe sugere?<span
                                        class="text-danger">*</span></label>
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Confiança</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Segurança</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Não transmite nada</label>
                                    </div>
                                    <small class="invalid-feedback">
                                        Por favor o campo é obrigatorio!
                                    </small>
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">2. O que acha do nosso logotipo?<span
                                        class="text-danger">*</span></label>
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Pouco criativo</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Sem significado</label>
                                    </div>
                                    <small class="invalid-feedback">
                                        Por favor o campo é obrigatorio!
                                    </small>
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">3. O que acha da cor da Índico Seguros?<span
                                        class="text-danger">*</span></label>
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Confiante</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Sugestiva</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">4. O que o nosso <i>slogan</i>, Viva Sem Medo
                                    lhe transmite?<span class="text-danger">*</span></label>
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Ter total confiança na
                                            seguradora para qualquer
                                            eventualidade</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Conduzir ou usufruir do bem com
                                            prudência, mas a confiar na
                                            seguradora</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Resolução de sinistros de forma
                                            muito rápida e
                                            eficiente</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">5. O que acha dos conteúdos partilhados na TV e
                                    Redes Sociais?<span class="text-danger">*</span></label>
                                <div class="">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Excelentes</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Informativos</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Apelativos</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Atractivos</label>
                                    </div><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                            id="" value="" required>
                                        <label class="form-check-label" for="">Pouco criativas</label>
                                    </div>
                                    <small class="invalid-feedback">
                                        Por favor o campo é obrigatorio!
                                    </small>
                            ...
                            <div class="mt-3 has-validation">
                                <label for="" class="fw-bold">Teria algum comentario adicional ou susgestões
                                    de melhoria sobre a
