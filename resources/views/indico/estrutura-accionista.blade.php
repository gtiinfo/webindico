...
<head>
    ...
    <title>Estrutura Accionista | ÍNDICO SEGUROS</title>
            ...
            <div class="box-center">
                <div class="box-medium" style="max-width: 650px;">
                    <div class="title-bar">
                        ...
                        <h4 class="title">Estrutura Accionista</h4>
                    </div>
                    <div class="content">
                        <table class="table table-sm table-striped text-nowrap">
                            <tbody>
                                <tr class="title">
                                    <td>Accionistas</td>
                                    <td style="text-align: center;">Nº Acções</td>
                                    <td style="text-align: center;">%</td>
                                    <td style="text-align: right;">Capital Realizado</td>
                                </tr>
                                <tr>
                                    <td>Indico Capitais e Investimentos, S.A.</td>
                                    <td style="text-align: center;">240,000</td>
                                    <td style="text-align: center;">80%</td>
                                    <td style="text-align: right;">292,000,000.00</td>
                                </tr>
                                <tr>
                                    <td>Capital Corporate Investments, S.A.</td>
                                    <td style="text-align: center;">27,000</td>
                                    <td style="text-align: center;">9%</td>
                                    <td style="text-align: right;">32,850,000.00</td>
                                </tr>
                                <tr>
                                    <td>Vinci - Consultoria e Serviços, S.A.</td>
                                    <td style="text-align: center;">18,000</td>
                                    <td style="text-align: center;">6%</td>
                                    <td style="text-align: right;">21,900,000.00</td>
                                </tr>
                                <tr>
                                    <td>Activa - Gestão de Risco, S.A.</td>
                                    <td style="text-align: center;">15,000</td>
                                    <td style="text-align: center;">5.00%</td>
                                    <td style="text-align: right;">18,250,000.00</td>
                                </tr>
                                <tr class="title">
                                    <td>TOTAL</td>
                                    <td style="text-align: center;">240,000</td>
                                    <td style="text-align: center;">100.00%</td>
                                    <td style="text-align: right;">365,000,000.00</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
