            ...
            <div class="">
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        ...
                        <div class="content">
                            <p class="content-text">E um produto financeiro que garante, por virtude da morte de
                                qualquer das pessoas
                                seguras, o pagamento das despesas relativas ao funeral e/ou o repatriamento dos corpos,
                                até ao limite do
                                                ...
                                                <div class="promo">
                                                    <div class="content">
                                                        <a class="btn btn-contacts"
                                                            href="../assets/documents/Seguro_Funeral.pdf">
                                                            <figure>
                                    ...
                                    <div class="gallery-content">
                                        ...
                                        <div class="gallery-card border-bottom-0">
                                            <div>
                                                ...
                                                <span>Para clientes que na referida data tiverem a idade compreendida
                                                    entre os 65 e 75 anos, cobrar-se-lhes-á um sobre prémio</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-cotacao">
                                ...
                                <form action="/particular/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Funeral">
