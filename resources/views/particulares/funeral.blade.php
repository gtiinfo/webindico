...
<head>
  ...
  <title>Funeral | ÍNDICO SEGUROS</title>
        ...
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            <div class="title-bar">
              ...
              <h4 class="title">Funeral</h4>
            </div>
            <div class="content">
              <p class="content-text">E um produto financeiro que garante, por virtude da morte de qualquer das pessoas
                seguras, o pagamento das despesas relativas ao funeral e/ou o repatriamento dos corpos, até ao limite do
                capital fixado por pessoa segura na apólice.</p>
            </div>
                  ...
                  <div class="row column-splitter">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                      <div class="row">
                        <div class="promo"> 
                          <div class="content">
                            <a class="btn btn-contacts" href="../assets/documents/Seguro_Funeral.pdf">
                              <figure>
                  ...
                  <div class="gallery-content">
                    ...
                    <div class="gallery-card border-bottom-0">
                      <div>
                        ...
                        <span>Cobertura aplicável para proponentes até 75 (Setenta e cinco) anos de idade</span>
                      </div>
                    </div>
                    <div class="gallery-card border-bottom-0">
                      <div>
                        <a href="#">
                          <img src="../assets/img/nursing-home.png" alt="">
                        </a>
                        <span>Para clientes que na referida data tiverem a idade compreendida entre os 65 e 75 anos, cobrar-se-lhes-á um sobre prémio</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
              <div class="img-cotacao">
                <img src="../assets/img/slides/funeral_larg.jpg" alt="">
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
              <div class="form-cotacao">
                <p class="title">Funeral</p>
        ...
        <div class="center-content">
          <div class="col-menu">
            <ul class="menu">
              ...
              <li><a href="./responsabilidade-civil-bombas.php">Resp. Civil Bombas</a></li>
          ...
          <div class="col-menu">
            <ul class="menu">
              ...
              <li><a href="../empresas/danos-proprios.php">Danos Próprios</a></li>
              <li><a href="../empresas/responsabilidade-civil-auto.php">Responsabilidade Civil</a></li>
              <li><a href=".;/empresas/saude.php">Saúde</a></li>
              <li><a href="../empresas/engenharia.php">Engenharias</a></li>
              <li><a href="../empresas/incendio.php">Incêndio</a></li>
              <li><a href="../empresas/responsabilidade-civil">Responsabilidade Civil Geral</a></li>
              <li><a href="../empresas/pme.php">PMEs</a></li>
            </ul>
          </div>
          <div class="col-menu">
            <ul class="menu">
              <li class="title">Institucional</li>
              <li><a href="./indico/historia.php">História</a></li>
              <li><a href="./indico/equipe-gestao.php">Equipe de Gestão</a></li>
              <li><a href="./indico/artigos.php">Artigos</a></li>
              <li><a href="./indico/estrutura-accionista.php">Estrutura Accionista</a></li>
              <li><a href="../indico/newsletter.php">Newsletter</a></li>
            </ul>
          </div>
          <div class="col-menu">
            <ul class="menu">
              <li class="title">Sinistros</li>
              <li><a href="./sinistros.php">Automóvel </a></li>
              <li><a href="./consultar-sinistro.php">Consultar Estado do Sinistro</a></li>
