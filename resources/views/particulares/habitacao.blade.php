                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                ...
                                <p class="subtitle">Peça uma simulação e seja contactado(a) por um profissional. Sem
                                    compromisso.</p>
                                <form action="/particular/enviar/cotacao" method="POST" class="needs-validation"
                                    novalidate enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nome Completo</label>
                                        <input type="hidden" name="product" value="Multirriscos Habitação">
                ...
                <div class="center-content">
                    <div class="col-menu">
                      <ul class="menu">
                        ...
                        <li><a href="{{ __(route('view.resp-civil-bombas-part')) }}">Respo. Civil Bombas</a></li>
