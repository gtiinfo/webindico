...
<head>
    ...
    <title>Viagem | ÍNDICO SEGUROS</title>
                ...
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        <div class="title-bar">
                            ...
                            <h4 class="title">Viagem</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">Garante a protecção em viagem, seja de férias, trabalho, estudo ou
                                lazer a nível
                                nacional ou internacional.</p>
                            <small>Benefícios</small>
                            <ul class="" style="list-style: none;">
                                <li><span><i class='bx bx-check me-2'></i>Indemnização por morte ou invalidez
                                        permanente</span>
                                </li>
                                <li><span><i class='bx bx-check me-2'></i></i>Pagamento de despesas médicas realizadas
                                        durante a viagem,
                                        em consequência de doença ou acidente</span></li>
                                <li><span><i class='bx bx-check me-2'></i>Salvaguarda perdas de passaporte, carta de
                                        condução e babagem
                                        bem como atrasos e demoras de partidas em caso de viagens aéreas</span></li>
                            </ul>
                        </div>
                                                ...
                                                <div class="promo">
                                                    <div class="content">
                                                        <a class="btn btn-contacts"
                                                            href="../assets/documents/Seguro_Viagem.pdf">
                                                            <figure>
                            ...
                            <div class="">
                                <div class="component-content">
                                    <div class="gallery-content">
                                        <div class="gallery-card border-bottom-0" style="width: calc(100%/3);">
                                            <div>
                                                <a href="#">
                                                    <img src="../assets/img/travel-luggage.png" alt="">
                                                </a>
                                                <span>A Perda de bagagem é apenas aplicável para viagens aéreas</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-bottom-0" style="width: calc(100%/3);">
                                            <div>
                                                <a href="#">
                                                    <img src="../assets/img/budget.png" alt="">
                                                </a>
                                                <span>Aviso prévio de cancelamento antes do inicio do período da viagem
                                                    e devolução do
                                                    certificado original do contrato do Seguro celebrado</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-bottom-0 border-bottom-0 "
                                            style="width: calc(100%/3);">
                                            <div>
                                                <a href="#">
                                                    <img src="../assets/img/growing-up.png" alt="">
                                                </a>
                                                <span>Cobertura aplicável para proponentes com idade compreendida entre
                                                    3 (três) meses e 80
                                                    (oitenta) anos</span>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/viagem_larg.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">Viagem</p>
                                ...
                                <form action="/particular/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Viagem">
