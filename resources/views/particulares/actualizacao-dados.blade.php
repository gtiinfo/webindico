...
<head>
  ...
  <title>Actualização de Capital | ÍNDICO SEGUROS</title>
        ...
        <div class="box-center">
          <div class="box-medium" style="max-width: 450px;">
            <div class="title-bar">
              ...
              <h4 class="title">Actualização de Capital</h4>
            </div>
            <div class="content">
              <form action="" class="needs-validation" novalidate>
                <h5 class="">1. Download dos Formulario</h5>
                <table class="table table-striped">
                  <thead>
                    <tr>
                      <th class="fw-bold">Documentos</th>
                      <th class="fw-bold">Link</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <th scope="row">Ficha Empresas</th>
                      <td>
                        <a href="../../assets/documents/Ficha_Empresas_v01_Editavel_FINAL.pdf"
                          target="_blank">Download</a>
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">Ficha Particulares</th>
                      <td>
                        <a href="../../assets/documents/Ficha_Individual_V01_Editavel_FINAL.pdf"
                          target="_blank">Download</a>
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">Ficha Questionário FATCA</th>
                      <td colspan="2">
                        <a href="../../assets/documents/Ficha_Questionario_FATCA.pdf" target="_blank">Download</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <h5 class="">2. Update dos Formularios e outros ducumentos</h5>
                <div class="mb-3">
                  <label class="form-label">Nome Completo<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" style="height: 45px;">
                </div>
                <div class="mb-3">
                  <label class="form-label">Nº de Apólice<span class="text-danger">*</span></label>
                  <input type="text" class="form-control" style="height: 45px;">
                </div>
                <div class="mb-3">
                  <label for="formFile" class="form-label">Anexar Formulários e Outros Documentos<span
