      ...
      <div class="">
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            ...
            <div class="content">
              <p class="content-text">São danos ou lesões sofridas pela pessoa Segura e aos seus beneficiários perante
                  ...
                  <div class="gallery-content">
                    <div class="gallery-card">
                      <div>
                        ...
                        <span>Autorização médica para o fornecimento de informações solicitadas pela ÍNDICO
                          SEGUROS</span>
                      </div>
                    </div>
                    <div class="gallery-card border-end-0">
                      <div>
                        ...
                        <span>Submissão aos exames efectuados por um médico designado ou aceite pela ÍNDICO
                          SEGUROS</span>
                      </div>
                    </div>
