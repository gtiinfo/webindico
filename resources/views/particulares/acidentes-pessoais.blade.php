...
<head>
    ...
    <title>Acidentes Pessoais | ÍNDICO SEGUROS</title>
                ...
                <div class="box-center">
                    <div class="box-medium" style="max-width: 650px;">
                        <div class="title-bar">
                            ...
                            <h4 class="title">Acidentes Pessoais</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">São danos ou lesões sofridas pela pessoa Segura e aos seus
                                beneficiários perante
                                as consequências de um acidente na esfera profissional.</p>
                            <small>Cobre os riscos resultantes</small>
                            <ul class="" style="list-style: none;">
                                <li><span><i class='bx bx-check me-2'></i>Acidente por causa súbita</span></li>
                                <li><span><i class='bx bx-check me-2'></i></i>Acidente por causa externa</span></li>
                                <li><span><i class='bx bx-check me-2'></i>Acidente por causa imprevisível</span></li>
                            </ul>
                        </div>
                                                ...
                                                <div class="promo">
                                                    <div class="content">
                                                        <a class="btn btn-contacts"
                                                            href="../assets/documents/Seguro_Acidentes_Pessoais_Grupo.pdf">
                                                            <figure>
                                ...
                                <div class="component-content">
                                    <div class="gallery-content">
                                        <div class="gallery-card">
                                            <div>
                                                <a href="#">
                                                    <img src="../assets/img/protection.png" alt="">
                                                </a>
                                                <span>Autorização médica para o fornecimento de informações solicitadas
                                                    pela ÍNDICO
                                                    SEGUROS</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-end-0">
                                            <div>
                                                ...
                                                <span>Submissão aos exames efectuados por um médico designado ou aceite
                                                    pela ÍNDICO
                                                    SEGUROS</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-bottom-0">
                                            <div>
                                                ...
                                                <span>Cumprimento das regras sobre saúde e segurança no trabalho</span>
                                            </div>
                                        </div>
                                        <div class="gallery-card border-bottom-0 border-end-0">
                                            <div>
                                                <a href="#">
                                                    <img src="../assets/img/old-man.png" alt="">
                                                </a>
                                                <span>Cobertura aplicável para proponentes até 75 (Setenta e cinco) anos
                                                    de idade</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="img-cotacao">
                            <img src="../assets/img/slides/acidentes_pessoais_larg.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                        <div class="form-cotacao">
                            <p class="title">Acidentes Pessoais</p>
                            ...
                            <form action="/particular/enviar/cotacao" method="POST" class="needs-validation"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="product" value="Acidentes Pessoais">
