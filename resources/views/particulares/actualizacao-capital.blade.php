            ...
            <div class="content">
              <form action="" class="needs-validation" novalidate>
                <div class="form-contact m-2">
                  ...
                  <div class="mb-4  has-validation">
                    <label class="form-label">Número do Cliente<span class="text-danger">*</span></label>
                  ...
                  <div class="mb-4  has-validation">
                    <label class="form-label">Capital a Declarar<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" required>
                    <small class="invalid-feedback">
                      Por favor o campo é obrigatorio!
                    </small>
                  ...
                  <div class="mb-4">
                    <button class="btn btn-primary btn-indico" href="#">Enviar</button>
                  </div>
                </div>
              </form> 
            </div>
