...
<head>
  ...
  <title>Responsabilidade Civil - Bombas | ÍNDICO SEGUROS</title>
        ...
        <div class="box-center">
          <div class="box-medium" style="max-width: 650px;">
            <div class="title-bar">
              ...
              <h4 class="title">Responsabilidade Civil - Bombas</h4>
            </div>
            <div class="content">
              <p>Nas bombas tem disponível a cobertura de responsabilidade civil com extensão de ocupantes da viatura segura</p>
              <small>Benefícios</small>
              <ul>
                <li><span>Responsabilidade civil contra terceiros (3.000.000,00 MT)</span></li>
                <li><span>Morte ou invalidez permanente (25.000,00 MT)</span></li>
                <li><span>Despesas médicas (5.000,00 MT)</span></li>
                <li><span>Despesas de funeral (2.500,00 MT)</span></li>
                <li><span>Benefícios funerários - Tomador de seguro e agregado familiar até 5 membros (25.000,00 MT)</span></li>
              </ul>
              <ul>
                <li><span>Preço: MZN 3,999.00</span></li>
              </ul>
            </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
              <div class="img-cotacao">
                <img src="../assets/img/slides/bombas_larg.jpg" alt="">
              </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7">
              <div class="img-cotacao">
                <iframe src="https://www.google.com/maps/d/embed?mid=19cvndb7Q2WJv9LC_hNxs0MeL4V-Vic0&ehbc=2E312F" width="100%" height="100%"></iframe>
              </div>
            </div>
          </div>
        </div>
