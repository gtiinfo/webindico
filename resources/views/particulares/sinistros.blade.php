...
<div class="modal top fade" style="z-index: 1111111" id="cookieconsent3" tabindex="-1" aria-labelledby="cookieconsentLabel3"
          ...
          <div class="content">
            <div class="mb-4">
              <select id="tipoSeguroParticular" class="form-control">
                ...
                <option value="acidentesPessoais">Acidantes Pessoais</option>
  ...
  <div class="card-form" style="height: 300px;">
    <div class="close top-3"></div>
    <div class="title">
      <h5 class="title-card">Dados</h5>
    </div>
    <div class="list-inpts">
      <form method="POST" enctype="multipart/form-data" class="form">
        ...
        <div class="mb-3">
          ...
          <input type="hidden" name="caminhoArquivoPDF" value="../../assets/documents/formularios/F.DS.01.R0 - Participacao Automovel  vFinal Editavel  Multilanguage 2022 - A.pdf">
        </div>
       
        <div class="mb-3">
          <button type="submit" class="btn btn-indico btn-primary" value="">Proximo</button> 
        </div>
      </form>
    </div>
  </div>
