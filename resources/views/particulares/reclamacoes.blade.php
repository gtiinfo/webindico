...
<head>
  ...
  <title>Reclamações | ÍNDICO SEGUROS</title>
            ...
            <div class="content">
              <form action="" class="needs-validation" novalidate>
                <div class="mt-3 has-validation">
                  <label for="" class="fw-bold">Qualidade do declarante<span class="text-danger">*</span></label>
                  <div class="">
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="" value="" required>
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="" value="" required>
                      <label class="form-check-label" for="">Beneficiario/Terceiro Lesado</label>
                    </div>
