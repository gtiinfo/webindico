...
<head>
    ...
    <title>Empregados Domésticos | ÍNDICO SEGUROS</title>
        ...
        <section class="box">
            <div class="">
                <div class="box-center">
                    <div class="box-medium" style="max-width: 500px;">
                        <div class="title-bar">
                            <div class="title-icon"></div>
                            <h4 class="title">Empregados Domésticos</h4>
                        </div>
                        <div class="content">
                            <p class="content-text">Com este Seguro, os trabalhadores domésticos estarão protegidos em
                                qualquer acidente derivado dos trabalhos domésticos e durante o período de actividade.
                            </p>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="img-cotacao">
                                <img src="../assets/img/slides/domestica_larg.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
                            <div class="form-cotacao">
                                <p class="title">Empregados Domésticos</p>
                                ...
                                <form action="/particular/enviar/cotacao" method="POST" class="needs-validation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="product" value="Empregados Domésticos">
