...
<body>
                                    ...
                                    <div class="row text-center mt-2 py-2">
                                        <div class="col-sm-3">
                                            <div class="my-2 my-sm-0">
                                                ...
                                                @endif
                                                <h3 class="fw-normal">
                                                    <span>{{ round($percUsers) }}%</span>
                                                </h3>
                                                <p class="text-muted mb-0">Usuário</p>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="my-2 my-sm-0">
                                                @if ($percRecrutamento >= 50)
                                                    <i class="mdi mdi-trending-up text-success mt-3 h3"></i>
                                                @else
                                                    <i class="mdi mdi-trending-down text-danger mt-3 h3"></i>
                                                @endif
                                                <h3 class="fw-normal">
                                                    <span>{{ round($percRecrutamento) }}%</span>
                                                </h3>
                                                <p class="text-muted mb-0">Recrutamento</p>
                                            </div>
    ...
    <script>
        ...
        var data = {
            labels: ["Usuários", "Newsletter", "Artigos", "Recrutamento"],
            datasets: [{
                label: "Progresso",
                backgroundColor: ["#00aeef", "#727cf5", "#fa5c7c",
                    "#ffc107"
                ],
                data: [{{ $user }}, {{ $newsletter }}, {{ $artigos }},
                    {{ $recrutamento }}
                ]
            }]
        };
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut', // Pode usar 'bar' ou outro tipo de gráfico adequado
            data: data,
            options: options
        });
    </script>
