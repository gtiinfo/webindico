                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-5">
                                            <a href="{{ __(route('view.noticias-add')) }}"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered w-100 dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                @forelse($newsletter as $key => $news)
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                                <input type="checkbox" class="form-check-input"
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('storage/upload/img/' . $news->image) }}"
                                                                alt="image"
                                                        ...
                                                        <td class="table-action">
                                                            <a href="/indico/noticia" class="action-icon"> <i
                                                                    class="mdi mdi-eye"></i></a>
                                                            <a href="/admin/noticia/edit/{{ $news->id }}"
                                                                class="action-icon"> <i
                                                            ...
                                                            <div class="modal-content modal-filled bg-danger">
                                                                <div class="modal-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <p class="mt-3">Se você deseja excluir
                                                                            permanentemente o artigo clica em sim</p>
                                                                        <form
                                                                            action="/admin/noticia/{{ $news->id }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                ...
                                <ul class="pagination pagination-rounded justify-content-end text-end py-3 pe-3">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $newsletter->previousPageUrl() }}"
                                                aria-label="Anterior">
                                    ...
                                    @if ($newsletter->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $newsletter->nextPageUrl() }}"
                                                aria-label="Próximo">
