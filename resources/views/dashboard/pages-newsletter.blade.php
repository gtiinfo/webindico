                                            ...
                                            <table class="table table-centered w-100 dt-responsive nowrap" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('storage/upload/img/'.$news->image) }}" alt="image" class="img-fluid avatar-sm rounded-circle" >
                                                        ...
                                                        <td class="table-action">
                                                            <a href="/indico/noticia" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <a href="/admin/noticia/edit/{{$news->id}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            ...
                                                            <div class="modal-content modal-filled bg-danger">
                                                                <div class="modal-body p-4">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <form action="/admin/noticia/{{ $news->id }}" method="POST">
                                                                            @csrf   
                                                                             @method('DELETE')
